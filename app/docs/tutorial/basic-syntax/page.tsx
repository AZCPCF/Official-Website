  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <p className="text-xl mb-8">
        In this tutorial, we'll cover the basic syntax of Cyrus Lang to get you started with writing your first
        programs.
      </p>
    ...
    println("Hello, World!")
      ...
      <p className="mb-4">This simple program demonstrates a few key elements of Cyrus Lang syntax:</p>
      <ul className="list-disc list-inside mb-6">
        <li>
          Functions are declared using the <code>func</code> keyword.
        </li>
        <li>
...
let pi = 3.14159`}</code>
      ...
      <p>In the next section, we'll dive deeper into variables and types in Cyrus Lang.</p>
    </div>
  )
}
